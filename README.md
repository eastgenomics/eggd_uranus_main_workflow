...
This workflow is a modified version of v1.9.0 (Novaseq) that is compatible with data produced by the Novaseq Instrument
...
|eggd_vcf_handler_for_uranus|2.5.1|
|cgppindel          |1.0.1|
|verifybamid        |2.1.0|
|picardqc           |1.0.0|
